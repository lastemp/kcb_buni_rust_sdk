use kcb_buni_rust_sdk::models::move_money::business_transfer::b2c::b2c::{
...
pub async fn test_b2c_payments(consumer_key: String, consumer_secret: String, _env: String) {
                    ...
                    if let Ok(optional_details) = _result {
                        ...
                        if let Ok(request_payload_details) = _result {
                            ...
                            if let Ok(account_details) = _result {
                                let _output = kcb_buni.b2c_payments(account_details);
